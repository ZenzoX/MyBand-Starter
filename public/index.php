...
$router->setBasePath('/PROJ/myBand/public');
...
$router->map( 'GET', '/', 'HomeController#homepage', 'home2' );

$router->map( 'GET', '/search', 'SearchController#searchpage', 'search' );
$router->map( 'GET', '/search/[a:tekst]', 'SearchController#resultpage', 'resultaat' );

$router->map( 'GET', '/agenda', 'AgendaController#agendapage', 'agenda' );

$router->map( 'GET', '/about', 'AboutUsController#aboutpage', 'about' );

$router->map( 'GET', '/contact', 'FormController#contactpage', 'contact' );

$router->map( 'GET', '/channel', 'ChannelsController#channelpage', 'channel' );

$router->map( 'GET', '/projects', 'ProjectsController#projectspage', 'projects' );
